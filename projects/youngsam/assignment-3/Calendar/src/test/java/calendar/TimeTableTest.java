		 ...
		 @Test
			...
			@Test	
		      ...
		      // create another appointment
				...
				assertNotNull(te.get(0));
				assertNotNull(te.get(1));
				assertEquals(17, te.get(0).getStartHour());
				assertEquals(15, te.get(1).getStartHour());
				assertEquals(2, te.size());
				assertEquals(1, te1.size());
			 ...
			 @Test
			  public void test16()  throws Throwable  {
				...
				assertEquals("\t --- 2/6/2018 --- \n --- -------- Appointments ------------ --- \n" +
					"\t2/2018/2018 at 4:30pm ,Birthday Party, This is my birthday party.\n \n", 
